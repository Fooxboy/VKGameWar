    ...
    public class Start: ICommand
    {
        ...
        private static void OneRunGame(long id)
        {
            var textHelp = $"🎉 Привет! Сейчас я тебе кратко расскажу, что у нас тут и как.😉" +
                $"\n😨 У нас тут война идёт! В прямом смылсе этого слова!" +
                ...
                $"\n😋 Кроме денег у нас есть и другие важные ресусры:" +
                ...
                $"\n✅ Напишите: Кейсы" +
                $"\n" +
                $"\n❤ У Нас ещё есть много чего интересного! Чтобы узнать все разделы, напишите: Разделы" +
