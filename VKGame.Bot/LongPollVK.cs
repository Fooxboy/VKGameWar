...
{
    /*===========================================================
     * Старое API лонг пулла ВКонтакте.
     * Сейчас используется Bots LongPoll
     * Находится тут: VKGame.Bot.BotsLongPollVK
     * Оставил этот файл только, чтобы не потерять весь этот код
     * Будет лень переписывать весь класс
     * Да ещё тут все события есть
     ===========================================================*/
